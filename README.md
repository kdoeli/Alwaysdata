...
```shell
wget -N https://raw.githubusercontent.com/kdoeli/Alwaysdata/main/vmess.sh && chmod +x ./vmess.sh
```

### vless

```shell
wget -N https://raw.githubusercontent.com/kdoeli/Alwaysdata/main/vless.sh && chmod +x ./vless.sh
```

### trojan

```shell
wget -N https://raw.githubusercontent.com/kdoeli/Alwaysdata/main/trojan.sh && chmod +x ./trojan.sh
```
...
端口：443
默认UUID：0e443104-37a0-4f60-a0cf-959f80161ce8
vmess额外id：0
加密：none
传输协议：ws
伪装类型：none
